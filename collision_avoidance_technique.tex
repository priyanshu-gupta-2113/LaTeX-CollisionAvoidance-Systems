...
\hypersetup{
    ...
    citecolor=blue      % Set the color of citation links (optional)
}
...
\begin{figure}[h]
\centering
\includegraphics[scale=0.2]{VISION.jpg}
...
\begin{figure}[h]
\centering
\includegraphics[scale=0.25]{LIDAR.jpg}
\caption{LIDAR}
\label{fig_LISP}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics[scale=0.25]{RADAR.jpg}
\caption{RADAR}
\label{fig_RADAR}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics[scale=0.25555555]{FUZZY.jpg}
\caption{FUZZY}
\label{fig_FUZZY}
\end{figure}
